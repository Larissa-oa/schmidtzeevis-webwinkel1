    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative bg-cream overflow-hidden">
          {/* Wavy pattern with faded blue */}
          <div className="absolute inset-0 opacity-[0.12] md:opacity-[0.08]">
            <svg className="absolute bottom-0 w-full h-32 md:h-40" viewBox="0 0 1440 120" preserveAspectRatio="none">
              <path 
                fill="currentColor" 
          ...
          <div className="absolute bottom-0 left-0 right-0">
            <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-10 md:h-12">
              <path 
