  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        elegant: "bg-navy text-primary-foreground font-medium hover:bg-navy-light",
        elegantOutline: "border border-navy text-navy font-medium hover:bg-navy hover:text-primary-foreground",
        gold: "bg-gold text-navy font-medium hover:bg-gold-dark",
      },
      size: {
        default: "h-10 px-5 py-2 rounded-sm",
        sm: "h-9 px-4 text-xs rounded-sm",
        lg: "h-11 px-8 rounded-sm",
        xl: "h-12 px-10 text-base rounded-sm",
